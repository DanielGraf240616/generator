...
// Rotary encoder
uint32_t encoderValue = 0; // Track state of rotary encoder
...
int8_t  direction = 0; // Tracking rotation of rotary encoder
...
// Setting frequency to 1 in case the frequency happens to be less than 1 Hz or in case frequency would exceed 12,5 MHz limit
